...
<div class="container">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="modal fade" id="edit<?php echo $data['tugasid']; ?>" tabindex="-1">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../config/aksi_tugas.php" method="POST">
                                ...
                                <label class="form-label">Deskripsi</label>
                                <textarea class="form-control" name="deskripsitugas"><?php echo $data['deskripsitugas']; ?></textarea>
                        </div>
            ...
            <div class="modal fade" id="hapus<?php echo $data['tugasid']; ?>" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="../config/aksi_tugas.php" method="POST">
                                <input type="hidden" name="tugasid" value="<?php echo $data['tugasid']; ?>">
                                Apakah Anda yakin ingin menghapus <strong><?php echo $data['namatugas']; ?></strong>?
                        </div>
                        <div class="modal-footer">
...
<footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; UKK PPLG 2024 | Mega Candra Vinata</p>
</footer>
